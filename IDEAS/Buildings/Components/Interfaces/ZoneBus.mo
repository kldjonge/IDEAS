...
connector ZoneBus
  ...
  IDEAS.Buildings.Components.Interfaces.nPortsurfPort nports_surf "The amount of fluidports the surface needs, used to communicate this to the zone" annotation ();
